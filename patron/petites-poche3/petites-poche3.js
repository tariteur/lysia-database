...
export async function appliquerTailles(
    ...
    try {
        setTailles(tailles);
var KX, CE, F2, CD, F, IN, io, KL, D_CM, D_1, FN, FM, DR, T;
        ...
        F2 = (((Number(dasin) / 4 + 9) / 2 - 2) + KX) - Number(dasin) * 0.088;
        document.querySelector("#point-1755277973890").setAttribute("cx", (F2 * 37.7952755906));
        CD = CE / 2 + KX / 2;
        ...
        io = (Number(dasin) / 4 + 9) / 2 + Number(mc) * 3;
        ...
        document.querySelector("#point-1755278188440\\/point-1755278187160\\/point-1755278184307\\/point-1755278198288\\/point-1755277983473\\/point-1755277981538\\/point-1755277968747").setAttribute("tension", 0.25);
        document.querySelector("#point-1755277976626\\/point-1755277975048\\/point-1755278189010\\/point-1755278195745\\/point-1755278197328\\/point-1755510007214\\/point-1755278199048\\/point-1755277982569\\/point-1755277980098\\/point-1755277967070\\/point-1755277963004").setAttribute("tension", 0.25);
